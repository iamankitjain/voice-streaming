...
async function microphoneEvent(){
  if(microphoneButton.style.color === 'green'){
    startStreaming();
  }
  else if(microphoneButton.style.color === 'orange'){
    stopStreaming();
  }
  else if(microphoneButton.style.color === 'red'){
    alert('Please check microphone access');
  } 
}
...
async function initAudio() {
  try {
    ...
    microphoneButton.style.color = "green";
...
async function startStreaming() {
  ...
  try {
    ...
    microphoneButton.style.color = "orange";
...
microphoneButton.addEventListener("click", microphoneEvent);
